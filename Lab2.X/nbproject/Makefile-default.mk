...
SOURCEFILES_QUOTED_IF_SPACED=main.c ADC.c ASCII.c LCD_libreria.c USART.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/ASCII.p1 ${OBJECTDIR}/LCD_libreria.p1 ${OBJECTDIR}/USART.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/ADC.p1.d ${OBJECTDIR}/ASCII.p1.d ${OBJECTDIR}/LCD_libreria.p1.d ${OBJECTDIR}/USART.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/ASCII.p1 ${OBJECTDIR}/LCD_libreria.p1 ${OBJECTDIR}/USART.p1

# Source Files
SOURCEFILES=main.c ADC.c ASCII.c LCD_libreria.c USART.c
...
${OBJECTDIR}/LCD_libreria.p1: LCD_libreria.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/LCD_libreria.p1 LCD_libreria.c 
